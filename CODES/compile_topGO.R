...
studies <- studies[-c(1,2)] # removing old folders
...
################################################################################
#Obtaining a matrix with 1 and 0 for upregulated genes to use in a Upset plot
...
close(pb)
################################################################################
#Obtaining a matrix with 1 and 0 for downregulated genes to use in a Upset plot
...
################################################################################
################################################################################
#plot top ten of GO Terms enriched using a heatmap
################################################################################
################################################################################
...
#getting GO terms names using AnnotationDbito use as labels
